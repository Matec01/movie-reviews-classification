...
- Creating a custom dataset by collecting comments from the website Letterboxd to ensure more diverse data and to evaluate model performance on related but distinct inputs.
...
![App visual](streamlit_app/app.png)
